...
2. `.claude/skills/frontend-design-audit/references/heuristics.md` — Detailed principle definitions and what to look for
...
3. **Evaluate systematically** — Go through all 15 principles. For each, inspect the code for violations. Reference `.claude/skills/frontend-design-audit/references/heuristics.md` for what to look for.
