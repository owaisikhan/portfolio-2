...
2. `.claude/skills/frontend-design-audit/references/heuristics.md` — What to look for
3. `.claude/skills/frontend-design-audit/references/patterns.md` — Fix patterns
...
4. **Implement** — Apply all auto-fix changes. Use patterns from `.claude/skills/frontend-design-audit/references/patterns.md`. Make minimal, targeted changes.
